      ...
      <div className="max-w-lg mx-auto p-4 space-y-4">
        <div className="rounded-xl p-4 flex items-start gap-3" style={{ backgroundColor: '#fbee57' }}>
          ...
          <p className="text-sm text-gray-800">
            <strong>Do not enter personal data</strong> into this form apart from the assessor's initials. If this assessment relates to a specific child or group of children, add any personal details directly to the downloaded Word document.
          </p>
        </div>
