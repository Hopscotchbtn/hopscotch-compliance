...
export const checkTypes = {
  ...
  roomSafety: {
    ...
    standardItems: [
      ...
      { id: 3, text: 'Fixtures and fittings should be secure and in good condition, including heater covers, finger guards and chairs / tables.' },
      ...
      { id: 5, text: 'Phone lines, intercoms and security cameras are working' },
