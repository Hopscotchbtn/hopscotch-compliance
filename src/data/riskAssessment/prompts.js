...
- IMPORTANT: Use plain, professional language. Describe ONLY the hazard itself — never describe the outcome or consequence. NEVER use words like "death", "serious injury", "fatality", "abduction", "struck by", "killed", "drowning" or any other outcome language. WRONG: "children could run onto the railway track causing serious injury or death". CORRECT: "unsupervised access to railway platform or track".
...
- IMPORTANT: Use plain, professional language throughout. Describe ONLY the hazard itself — never include outcomes or consequences. NEVER use words like "death", "fatal", "serious injury", "abduction", "struck by", "killed", "drowning" or any outcome language. WRONG: "children could run onto railway track causing serious injury or death". CORRECT: "unsupervised access to railway platform or track".
