    ...
    <div className="min-h-screen bg-hop-pebble px-4 py-8 flex items-center justify-center">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center text-gray-400 text-xs mt-6 px-2 leading-relaxed">
          By using this tool, staff acknowledge that their initials will be recorded against compliance checks. This data is processed under legal obligation (food safety and Ofsted regulations) and retained for 1 year. For queries contact your manager.
        </p>
